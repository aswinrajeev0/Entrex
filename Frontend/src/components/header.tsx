        ...
        <header className="relative flex justify-between items-center px-4 sm:px-8 md:px-12 py-4">
            ...
            <nav className="hidden lg:block">
                <ul className="flex space-x-6 xl:space-x-8 text-white text-lg">
                    ...
                    <li className="hover:text-blue-400 cursor-pointer transition-colors">Services</li>
            ...
            <button
                className="lg:hidden flex flex-col justify-center items-center space-y-1 p-2 z-50"
            ...
            {/* Mobile Menu */}
            <nav
                className={`lg:hidden absolute top-full left-0 z-10 w-full bg-[#000000e8] bg-opacity-90 text-white transition-all duration-300 ease-in-out rounded-[10px] ${
