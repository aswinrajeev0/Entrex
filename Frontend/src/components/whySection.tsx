                    ...
                    <div className="col-span-4 space-y-12">
                        ...
                        <div className="text-right">
                            <div className="flex justify-end items-center mb-3">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">Premium Chauffeurs</h3>
                            </div>
                        ...
                        <div className="text-right">
                            <div className="flex justify-end items-center mb-3">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">Well-Maintained Vehicles</h3>
                            </div>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="col-span-4 space-y-12">
                        ...
                        <div className="text-left">
                            <div className="flex items-center mb-3">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">Punctual & Reliable</h3>
                            </div>
                            <p className="text-gray-600 leading-relaxed">
                        ...
                        <div className="text-left">
                            <div className="flex items-center mb-3">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">24×7 Dedicated Support</h3>
                            </div>
                            <p className="text-gray-600 leading-relaxed">
