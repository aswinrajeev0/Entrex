        ...
        <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-4 relative inline-block">
                        Why{" "}
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    {/* Left Features */}
                    <div className="md:col-span-4 space-y-8 sm:space-y-12 order-2 md:order-1">
                        {[
                            {
                    ...
                    {/* Right Features */}
                    <div className="md:col-span-4 space-y-8 sm:space-y-12 order-3">
                        {[
                            {
                            ...
                            },
                            {
                                ...
                                icon: <span className="text-white text-xs font-bold">24</span>,
                            },
                        ].map((item, i) => (
                            <div key={i} className="text-left">
                                <div className="flex items-center mb-3">
                                    <div className="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center mr-3">
                                        {typeof item.icon === "string" ? item.icon : <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">{item.icon}</svg>}
                                    </div>
                                    <h3 className="text-lg sm:text-xl font-bold text-gray-800">{item.title}</h3>
                                </div>
                                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">{item.desc}</p>
